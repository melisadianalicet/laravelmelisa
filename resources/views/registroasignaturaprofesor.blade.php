...
<h5 class="blog-title"><font face="gabriola" color="#26CE53" size="5"><center>Por favor Ingrese el nit del profesor</center></b></br>

  <table width="40%" height="100" border="0" align="center" cellpadding="11" cellspacing="11">
    <tr>
    <center><form id="form1" name="form1" method="get" action="{!!('buscarasipro')!!}" >
    <td>
...
<center><button type="submit" style="background:#7EDB04; width:200px; height:40px" name="submit" ><font size="5"color="black" face="gabriola">Guardar</font></button></a>
          ...
          <a href ="{!!('modificarasigpro')!!}"> <button type="submit" style="background:#7EDB04; width:200px; height:40px" name="submit" ><font size="5"color="black" face="gabriola">Modificar</font></button></a></center><br>           
