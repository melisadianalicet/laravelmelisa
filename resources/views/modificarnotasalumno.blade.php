...
<center><table width="20" height="70" border="0" align="left" ></center>
  <center><tr>
  <td><td><td><center><form id="form1" name="form1" method="get" action="{!!('buscarcodregnotas')!!}" >
...
<center><button type="submit" style="background:#7EDB04; width:100px; height:35px" name="submit" ><font size="5"color="black" face="gabriola">Buscar</font></button></a></center><br>
   ...
   <td width="100"><label>
    ...
    <td width="100"><label>
      <input name="notf" type="text" id="notf" style="width:100px; height:30px" />
    </label>     
    </td>
    <td width="100"><label>
 ...
 <button type="submit" style="background:#7EDB04; width:90px; height:35px" name="submit" ><font size="5"color="black" face="gabriola">Modificar</font></button></a></td>
    ...
    <tr><td>
    <tr><td><a href ="{!!('registronotasal')!!}"> <button type="submit" style="background:#7EDB04; width:90px; height:35px" name="submit" ><font size="5"color="black" face="gabriola">Atras</font></button></a></td></tr>
   </table>
