...
<br></br>
  ...
  <table width="40%" height="100" border="0" align="center" cellpadding="7" cellspacing="7">
   ...
   <td width="200"><label>
    ...
    <td>
   <center><button type="submit" style="background:#7EDB04; width:90px; height:35px" name="submit" ><font size="5"color="black" face="gabriola">Actualizar</font></button></td>
    
   
   </table>
   </form>
  <br><br>
    <a href ="{!!('modificarexpro')!!}"> <button type="submit" style="background:#7EDB04; width:90px; height:35px" name="submit" ><font size="5"color="black" face="gabriola">Atras</font></button></a></td></tr>
    </div>
