...
<br></br>
    <div class="container">
      ...
      <div class="blog-header">
        <h1 class="blog-title"><font face="gabriola" color="#26CE53">~ Actualizacion de datos ~ Ex-Profesores ~</font></h1>
         <h2 class="blog-title"><font face="gabriola" color="#26CE53">Por favor Ingrese el Nit del Ex-Profesor</font></h2><br></br>
        
  <table width="40%" height="100" border="0" align="center" cellpadding="7" cellspacing="7">
    <tr>
    <td>
<form id="form1" name="form1" method="get" action="{!!('buscarexpro')!!}" >
    <td>
<center> <button type="submit" style="background:#7EDB04; width:100px; height:35px" name="submit" ><font size="5"color="black" face="gabriola">Buscar</font></button></a></center>
   ...
   <td width="200"><label>
    ...
    <td>
   <a href ="registro_exprofesor.html"> <button type="submit" style="background:#7EDB04; width:90px; height:35px" name="submit" ><font size="5"color="black" face="gabriola">Actualizar</font></button></a></td>
    </tr>
   
   </table>
   </form>
  <br><br>
    <a href ="{!!route('registroexpro')!!}"> <button type="submit" style="background:#7EDB04; width:90px; height:35px" name="submit" ><font size="5"color="black" face="gabriola">Atras</font></button></a></td></tr>
    </div>
