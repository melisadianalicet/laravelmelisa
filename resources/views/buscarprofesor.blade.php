...
<br></br>
    <div class="container">
      ...
      <div class="blog-header">
        <h1 class="blog-title"><font face="gabriola" color="#26CE53">~ Actualizacion de datos ~ Profesores ~</font></h1>
         ...
         <form id="form1" name="form1" method="get" action="{!!('modificacionpro')!!}" >
  ...
  <br><br>
    <a href ="{!!('actualizacionpro')!!}"> <button type="submit" style="background:#7EDB04; width:90px; height:35px" name="submit" ><font size="5"color="black" face="gabriola">Atras</font></button></a></td></tr>
    </div>
