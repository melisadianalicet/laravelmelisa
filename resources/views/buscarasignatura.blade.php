...
<br></br>
    <div class="container">
      <div class="blog-header">
        <center><h1 class="blog-title"><font face="gabriola" color="#26CE53">~ Actualizacion de datos ~ Asignatura ~</
        <br> <h2 class="blog-title"><font face="gabriola" color="#26CE53">Por favor ve atras si deseas hacer otra consulta</font></h2><br></br></center>
           ...
           <form id="form1" name="form1" method="get" action="{!!('modificacionasi')!!}" >
 ...
 <button type="submit" style="background:#7EDB04; width:90px; height:35px" name="submit" ><font size="5"color="black" face="gabriola">Actualizar</font></button></a></td>
  ...
  <br><br>
    <a href ="{!!('actualizarasig')!!}"> <button type="submit" style="background:#7EDB04; width:90px; height:35px" name="submit" ><font size="5"color="black" face="gabriola">Atras</font></button></a></td></tr>
    </div>
